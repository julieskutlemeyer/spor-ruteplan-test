...
function pick(supportedLanguages, acceptLanguage, options = { loose: false }) {
  ...
  let parsedAcceptLanguage = isString2(acceptLanguage) ? parse(acceptLanguage) : acceptLanguage;
...
var RemixI18Next = class {
  ...
  getRouteNamespaces(context) {
    let namespaces = Object.values(context.routeModules).flatMap((route) => {
      if (typeof (route == null ? void 0 : route.handle) !== "object")
        return [];
      if (!route.handle)
        return [];
  ...
  async getFixedT(requestOrLocale, namespaces, options = {}) {
    ...
    await instance2.changeLanguage(locale);
    if (namespaces)
      await instance2.loadNamespaces(namespaces);
    else if (instance2.options.defaultNS) {
      await instance2.loadNamespaces(instance2.options.defaultNS);
    } else
      await instance2.loadNamespaces("translation");
    return instance2.getFixedT(locale, namespaces, options == null ? void 0 : options.keyPrefix);
  }
